...
enum class PrimePartType(@param:StringRes val text: Int, @param:DrawableRes val icon: Int) {
    BLUEPRINT(R.string.comp_blueprint, R.drawable.prime_blueprint),
    ...
    BLADES(R.string.comp_blade, R.drawable.prime_blade),
    ...
    UPPER_LIMB(R.string.comp_ulimb, R.drawable.prime_blade),
    LOWER_LIMB(R.string.comp_llinb, R.drawable.prime_blade),
