...
sealed class BottomNavItem(var title: Int, var icon: Int, var screenRoute: String, var filter: String) {
    ...
    object OtherPrimes : BottomNavItem(R.string.menu_other_prime, R.drawable.ic_lato_prime, "other_primes", "other_filter")
    object Relics : BottomNavItem(R.string.menu_relics, R.drawable.ic_relic, "relic_list", "relic_filter")
